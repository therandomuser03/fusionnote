      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        >
          <div
            ...
            className="relative left-[calc(50%-11rem)] aspect-1155/678 w-144.5 -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-288.75 pointer-events-none"
          />
        </div>
        <div className="mx-auto max-w-6xl py-16 sm:py-24 lg:py-28">
          <div className="text-left">
            <h1 className="text-balance text-5xl font-semibold leading-none tracking-tighter sm:text-6xl md:text-7xl lg:text-8xl">
              Fusion
              <LineShadowText className="italic">Note</LineShadowText>
            </h1>
            ...
            <p className="mt-8 max-w-7xl text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
              Built for speed, privacy, and powerful collaboration — in your
              workflow.
            </p>
        ...
        >
          <div
            ...
            className="relative left-[calc(50%+3rem)] aspect-1155/678 w-144.5 -translate-x-1/2 bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%+36rem)] sm:w-288.75 pointer-events-none"
          />
        </div>
      </div>
    </div>
